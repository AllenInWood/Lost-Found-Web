    ...
    <div class="container">
      ...
      <div class="news col-md-12">
       ...
       <div class="kuai1">
        ...
        <form action="ServAddFindOwners" method="post" class="form-horizontal" style="style="width:100%;margin-top:20px;margin-bottom:20px">
      <div class="control-group">
        <label class="control-label" style="margin-left:50%">题目</label>
        <div class="controls">
          <input type="text" name="titleFindOwners" placeholder="题目" style="width:100%">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label" style="margin-left:50%">内容</label>
        <div class="controls">
          <textarea rows="3" name="contentFindOwners" placeholder="内容" style="width:100%"></textarea>
        </div>
      </div>
